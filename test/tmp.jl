...
tests_u  = TestFESpace(model,reffe_u,dirichlet_tags=[1,2,3,4,5,7,8])
...
# using A partitioned vector... .

# we solve a problem to get the preconditioned matrix ....  

# Solve a problem (cheap) to get the hessian vceto





# how can we do the correct operations with the preconditioner ? 
