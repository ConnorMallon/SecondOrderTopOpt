...
function objective_partials(J,uh,φh,u̇,ṗ,U,V,V_φ)
  # ∂²J / ∂u² * u̇
...
function incremental_adjoint_partials(res,uh,λh,φh,u̇,ṗ,U,V,V_φ)
  # ∂²R / ∂u² * u̇ * λ
...
function incremental_adjoint_value(res,J,uh,λh,φh,u̇,ṗ,du̇,∂2R∂u2_mat_u̇,∂2R∂u∂φ_mat_ṗ,U,V,V_φ)
  # RHS 
...
function incremental_adjoint_pushforward(res,J,uh,λh,φh,u̇,ṗ,du̇,U,V,V_φ)
