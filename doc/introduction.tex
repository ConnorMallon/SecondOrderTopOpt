...
Similar results are shown for basic shape recoveries in boundary fitted settings \cite{Gangl2020,Etling2018} by using second order shape derivatives. 
...
The method that we propose in this work is a reparametrisation of the design space which allows superlinear convergence in early iterations without the need for continuation.
